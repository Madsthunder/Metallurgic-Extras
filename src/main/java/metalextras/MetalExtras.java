...
public class MetalExtras
{
	...
	public static class Proxy
	{
		...
		public void init()
		{
			...
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(COPPER_NUGGET, 9), "ingotCopper"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TIN_NUGGET, 9), "ingotTin"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ALUMINUM_NUGGET, 9), "ingotAluminum"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(LEAD_NUGGET, 9), "ingotLead"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(SILVER_NUGGET, 9), "ingotSilver"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(COPPER_INGOT), "NNN", "NNN", "NNN", 'N', "nuggetCopper"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TIN_INGOT), "NNN", "NNN", "NNN", 'N', "nuggetTin"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ALUMINUM_INGOT), "NNN", "NNN", "NNN", 'N', "nuggetAluminum"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(LEAD_INGOT), "NNN", "NNN", "NNN", 'N', "nuggetLead"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(SILVER_INGOT), "NNN", "NNN", "NNN", 'N', "nuggetSilver"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(COPPER_INGOT, 9), "blockCopper"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(TIN_INGOT, 9), "blockTin"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ALUMINUM_INGOT, 9), "blockAluminum"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(LEAD_INGOT, 9), "blockLead"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(SILVER_INGOT, 9), "blockSilver"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(ENDER_GEM, 9), "blockEnder"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(SAPPHIRE_GEM, 9), "blockSapphire"));
			GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(RUBY_GEM, 9), "blockRuby"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(COPPER_BLOCK), "III", "III", "III", 'I', "ingotCopper"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TIN_BLOCK), "III", "III", "III", 'I', "ingotTin"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ALUMINUM_BLOCK), "III", "III", "III", 'I', "ingotAluminum"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(LEAD_BLOCK), "III", "III", "III", 'I', "ingotLead"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(SILVER_BLOCK), "III", "III", "III", 'I', "ingotSilver"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ENDER_BLOCK), "III", "III", "III", 'I', "gemEnder"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(SAPPHIRE_BLOCK), "III", "III", "III", 'I', "gemSapphire"));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(RUBY_BLOCK), "III", "III", "III", 'I', "gemRuby"));
