...
public abstract class OreType implements Comparable<OreType>
{
	...
	public OreType(OreTypes types, IBlockState state, Characteristic... characteristics)
	{
		this.state = state;
		this.types = types;
		this.characteristics = Lists.newArrayList(characteristics);
	}
	...
	public static class Impl extends OreType
	{
		...
		public Impl(OreTypes types, IBlockState state, Characteristic... characteristics)
		{
			super(types, state, characteristics);
